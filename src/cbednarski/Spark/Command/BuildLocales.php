...
class BuildLocales extends Command
{
    protected function configure()
    {
        $this->setName('build-locales');
        $this->setDescription('Build a localized spark project under the specified directory');
        $this->addArgument(
            'directory',
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('<info>Building localized project under ' . realpath($directory) . '</info>');
